...
use crate::{
    check_aligned, check_cop_usable, exception::Exception, inst, instructions::InstructionEffect,
    system::Address,
};
...
fn lb_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LB {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn lbu_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LBU {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn ld_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LD {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn ldl_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LDL {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn ldr_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LDR {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn lh_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LH {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn lhu_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LHU {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn ll_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LL {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn lld_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LDD {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn lw_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LW {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn lwl_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LWL {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn lwr_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LWR {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn lwu_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "LWU {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn sb_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SB {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn sc_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SC {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn scd_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SCD {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn sd_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SD {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn sdc1_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SDC1 {}, {:#06X}({})",
        op.ftn(),
        op.imm16(),
...
fn sh_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SH {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn sw_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SW {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn swl_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SWL {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn swr_disassemble(_s: &System, op: Opcode) -> Disassembly {
    Disassembly::new(format!(
        "SWR {}, {:#06X}({})",
        op.rtn(),
        op.imm16(),
...
fn syscall_disassemble(_s: &System, _op: Opcode) -> Disassembly {
