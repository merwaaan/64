...
instructions! {
    ...
    Div = 0x0000_001A { rs rt },
    Divu = 0x0000_001B { rs rt },
    Dmult = 0x0000_001C { rs rt },
    Dmultu = 0x0000_001D { rs rt },
    Ddiv = 0x0000_001E { rs rt },
    Ddivu = 0x0000_001F { rs rt },
    ...
    Ldl = 0x6800_0000 { base rt offset },
    Ldr = 0x6C00_0000 { base rt offset },
    Lb = 0x8000_0000 { base rt offset },
    Lh = 0x8400_0000 { base rt offset },
    Lwl = 0x8800_0000 { base rt offset },
    Lw = 0x8C00_0000 { base rt offset },
    Lbu = 0x9000_0000 { base rt offset },
    Lhu = 0x9400_0000 { base rt offset },
    Lwr = 0x9800_0000 { base rt offset },
    Lwu = 0x9C00_0000 { base rt offset },
    Sb = 0xA000_0000 { base rt offset },
    Sh = 0xA400_0000 { base rt offset },
    Swl = 0xA800_0000 { base rt offset },
    Sw = 0xAC00_0000 { base rt offset },
    Sdl = 0xB000_0000 { base rt offset },
    Sdr = 0xB400_0000 { base rt offset },
    Swr = 0xB800_0000 { base rt offset },
    Ll = 0xC000_0000 { base rt offset },
    Lld = 0xD000_0000 { base rt offset },
    ...
    Tltiu = 0x040B_0000 { rs imm },
    Teqi = 0x040C_0000 { rs imm },
    Tnei = 0x040E_0000 { rs imm },
}
